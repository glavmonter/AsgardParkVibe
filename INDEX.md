...
## 🆕 Бонус: Stateless версия

Я создал **ДВЕ реализации** конечного автомата:

### 1. Custom MediatR (основная)
📁 `src/ParkingEntry.Core/`
- ✅ Максимальная гибкость
- ✅ Легкие тесты с любого состояния
- ✅ 600 строк кода

### 2. Stateless Library (альтернатива)
📁 `stateless-version/`
- ✅ **66% меньше кода** (200 строк!)
- ✅ Автоматическая валидация переходов
- ✅ Визуализация графа (auto-generated)
- ✅ Формальная корректность

**Сравнение:** [STATELESS_COMPARISON.md](./STATELESS_COMPARISON.md)
